...
from utilities import plot_training_rewards
...
def mini_batch_train(env, agent, max_episodes, batch_size, target_update_freq,checkpoint_dir,use_NRM): ##TRAINER func with MINIBATCHES
    ...
    # Check for existing rewards array and load (only one file)
...
##START TRAINING
mini_batch_train(env, agent, MAX_EPISODES, BATCH_SIZE,target_update_freq,'checkpoints2',use_NRM)
